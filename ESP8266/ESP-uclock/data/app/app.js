...
function renderWordclock(active, settings, layoutPreview) {
  ...
  renderWordclockCorners(active, settings, preview);
  scheduleWordclockSizing();
}
...
function renderWordclockCorners(active, settings, layoutPreview) {
  ...
  const activeCount = active && is12hLayout ? minute % 5 : 0;
